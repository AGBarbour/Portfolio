...
function createMap(earthquakes, boundaries) {
  ...
  var portfolio_link = L.control({ position: "topright" });
  portfolio_link.onAdd = function() {
    var div = L.DomUtil.create("div", "info legend");
    var link = "<a  class=\"link\" href='../index.html'>Portfolio</a>"
    div.innerHTML = link;

    return div;
  
  };
  portfolio_link.addTo(myMap);
}
